...
namespace CarFleetMS.Controllers
{
    public class VehicleTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("VehicleTypeId,Variant,Version")] VehicleType vehicleType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VehicleTypeId,Variant,Version")] VehicleType vehicleType)
        {
